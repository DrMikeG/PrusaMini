...
module textlessclamp() {
    difference()
    {
        union() {
            rotate([0,0,0])     
            import("C:/!Projects/3D Printing/Tools-ClampItSquare/files/J-Max_ClampItSquare_Large.STL");
            translate([0, 6, 0]) color("red") cube([2,145,35]);
            translate([34, 183, 0]) color("green") cube([144,2,35]);
        }
    }
}
